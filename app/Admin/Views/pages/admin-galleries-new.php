...
if (!isset($categoryData)) {
    ...
    foreach ($galleries as $gallery) {
        $categoryData[] = [
            ...
            'thumbnail' => $gallery['icon_default'] ?? '/assets/images/404.jpg',
...
function handleThumbnailUpload(event) {
    ...
    // 上传到服务器
    fetch('/admin/ajax?controller=galleries&ajax=upload_thumbnail', {
        method: 'POST',
        body: formData
    })
    .then(res => res.json())
...
function removeThumbnail() {
    ...
    fetch('/admin/ajax?controller=galleries&ajax=remove_thumbnail', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
