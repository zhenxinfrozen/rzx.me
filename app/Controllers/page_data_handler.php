...
function get_page_specific_data($viewFile) {
    ...
    // 为不同页面提供特定数据
    if ($viewFile === 'home.php' || $viewFile === 'pages/home.php') {
        $data['page_id'] = 'home';
        $data['page_title'] = 'rzx.me - 首页';
        $data['css_file'] = '/assets/css/home_style.css';
        // 使用默认的 meta 信息
    } elseif ($viewFile === 'comic.php' || $viewFile === 'pages/comic.php') {
        $data['page_id'] = 'comic';
    ...
    } elseif ($viewFile === 'comic-gallery.php' || $viewFile === 'pages/comic-gallery.php') {
    ...
    } elseif ($viewFile === 'animation.php' || $viewFile === 'pages/animation.php') {
    ...
    } elseif ($viewFile === 'latest.php' || $viewFile === 'pages/latest.php') {
        $data['page_id'] = 'latest';
    ...
    } elseif ($viewFile === 'pictures.php' || $viewFile === 'pages/pictures.php') {
    ...
    } elseif ($viewFile === 'sketch.php' || $viewFile === 'pages/sketch.php') {
        $data['page_id'] = 'sketch';
    ...
    } elseif ($viewFile === 'sketch-test.php' || $viewFile === 'pages/sketch-test.php') {
        ...
        $data['meta_keywords'] = '速写，草图，练习作品，sketchbook，drawing，concept sketches';
    } elseif ($viewFile === 'sites.php' || $viewFile === 'pages/sites.php') {
        $data['page_id'] = 'sites';
    ...
    } elseif ($viewFile === 'about.php' || $viewFile === 'pages/about.php') {
        $data['page_id'] = 'about';
