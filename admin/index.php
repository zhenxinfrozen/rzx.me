...
$stats = [
    'total_pages' => 6,
    'total_galleries' => count(glob(__DIR__ . '/../public/assets/images/galleries/*', GLOB_ONLYDIR)),
    'total_images' => count(glob(__DIR__ . '/../public/assets/images/galleries/*/*.{jpg,jpeg,png,gif}', GLOB_BRACE)),
    'storage_used' => formatBytes(getDirSize(__DIR__ . '/../public/assets'))
];
